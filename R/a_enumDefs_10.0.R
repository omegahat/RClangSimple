# Autogenerated 2020-03-26

if(all(clangVersionNum(libclangVersion_Install) == c(10, 0))) {

setClass("clockid_t", contains = "EnumValue")



clockid_t = clockid_tValues = structure(c(0L, 6L, 4L, 5L, 8L, 9L, 12L, 16L), .Names = c('_CLOCK_REALTIME', '_CLOCK_MONOTONIC', '_CLOCK_MONOTONIC_RAW', '_CLOCK_MONOTONIC_RAW_APPROX', '_CLOCK_UPTIME_RAW', '_CLOCK_UPTIME_RAW_APPROX', '_CLOCK_PROCESS_CPUTIME_ID', '_CLOCK_THREAD_CPUTIME_ID'))



`_CLOCK_REALTIME` = GenericEnumValue('_CLOCK_REALTIME', 0L, 'clockid_t')

`_CLOCK_MONOTONIC` = GenericEnumValue('_CLOCK_MONOTONIC', 6L, 'clockid_t')

`_CLOCK_MONOTONIC_RAW` = GenericEnumValue('_CLOCK_MONOTONIC_RAW', 4L, 'clockid_t')

`_CLOCK_MONOTONIC_RAW_APPROX` = GenericEnumValue('_CLOCK_MONOTONIC_RAW_APPROX', 5L, 'clockid_t')

`_CLOCK_UPTIME_RAW` = GenericEnumValue('_CLOCK_UPTIME_RAW', 8L, 'clockid_t')

`_CLOCK_UPTIME_RAW_APPROX` = GenericEnumValue('_CLOCK_UPTIME_RAW_APPROX', 9L, 'clockid_t')

`_CLOCK_PROCESS_CPUTIME_ID` = GenericEnumValue('_CLOCK_PROCESS_CPUTIME_ID', 12L, 'clockid_t')

`_CLOCK_THREAD_CPUTIME_ID` = GenericEnumValue('_CLOCK_THREAD_CPUTIME_ID', 16L, 'clockid_t')



 setAs("character", "clockid_t", function(from) asEnumValue(from, clockid_tValues, "clockid_t", prefix = '_CLOCK_') )

 setAs("integer", "clockid_t", function(from) asEnumValue(from, clockid_tValues, "clockid_t", prefix = '_CLOCK_') )

 setAs("numeric", "clockid_t", function(from) asEnumValue(from, clockid_tValues, "clockid_t", prefix = '_CLOCK_') )
...
`CXCursor_LastExpr` = GenericEnumValue('CXCursor_LastExpr', 149L, 'CXCursorKind')
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 285L, 'CXCursorKind')
...
`CXType_LastBuiltin` = GenericEnumValue('CXType_LastBuiltin', 38L, 'CXTypeKind')
