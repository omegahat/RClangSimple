# Autogenerated 2022-12-30

if(all(clangVersionNum(libclangVersion_Install) == c(15, 0))) {
...
`CXCursor_LastExpr` = GenericEnumValue('CXCursor_LastExpr', 154L, 'CXCursorKind')
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 304L, 'CXCursorKind')
