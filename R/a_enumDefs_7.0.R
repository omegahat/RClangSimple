# Autogenerated 2017-07-05

if(all(clangVersionNum(libclangVersion_Install) == c(7, 0))) {
...
CXCallingConv = CXCallingConvValues = structure(c(0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 100L, 200L), .Names = c('CXCallingConv_Default', 'CXCallingConv_C', 'CXCallingConv_X86StdCall', 'CXCallingConv_X86FastCall', 'CXCallingConv_X86ThisCall', 'CXCallingConv_X86Pascal', 'CXCallingConv_AAPCS', 'CXCallingConv_AAPCS_VFP', 'CXCallingConv_X86RegCall', 'CXCallingConv_IntelOclBicc', 'CXCallingConv_X86_64Win64', 'CXCallingConv_X86_64SysV', 'CXCallingConv_X86VectorCall', 'CXCallingConv_Swift', 'CXCallingConv_PreserveMost', 'CXCallingConv_PreserveAll', 'CXCallingConv_Invalid', 'CXCallingConv_Unexposed'))
