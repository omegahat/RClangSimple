...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 232L, 'CXCursorKind')
...
`CXCursor_LastAttr` = GenericEnumValue('CXCursor_LastAttr', 408L, 'CXCursorKind')
...
`CXCallingConv_PnaclCall` = GenericEnumValue('CXCallingConv_PnaclCall', 8L, 'CXCallingConv')
...
#####################################
setClass("CXCommentKind", contains = "EnumValue")

CXCommentKind = CXCommentKindValues = structure(c(0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L), .Names = c('CXComment_Null', 'CXComment_Text', 'CXComment_InlineCommand', 'CXComment_HTMLStartTag', 'CXComment_HTMLEndTag', 'CXComment_Paragraph', 'CXComment_BlockCommand', 'CXComment_ParamCommand', 'CXComment_TParamCommand', 'CXComment_VerbatimBlockCommand', 'CXComment_VerbatimBlockLine', 'CXComment_VerbatimLine', 'CXComment_FullComment'))

`CXComment_Null` = GenericEnumValue('CXComment_Null', 0L, 'CXCommentKind')
`CXComment_Text` = GenericEnumValue('CXComment_Text', 1L, 'CXCommentKind')
`CXComment_InlineCommand` = GenericEnumValue('CXComment_InlineCommand', 2L, 'CXCommentKind')
`CXComment_HTMLStartTag` = GenericEnumValue('CXComment_HTMLStartTag', 3L, 'CXCommentKind')
`CXComment_HTMLEndTag` = GenericEnumValue('CXComment_HTMLEndTag', 4L, 'CXCommentKind')
`CXComment_Paragraph` = GenericEnumValue('CXComment_Paragraph', 5L, 'CXCommentKind')
`CXComment_BlockCommand` = GenericEnumValue('CXComment_BlockCommand', 6L, 'CXCommentKind')
`CXComment_ParamCommand` = GenericEnumValue('CXComment_ParamCommand', 7L, 'CXCommentKind')
`CXComment_TParamCommand` = GenericEnumValue('CXComment_TParamCommand', 8L, 'CXCommentKind')
`CXComment_VerbatimBlockCommand` = GenericEnumValue('CXComment_VerbatimBlockCommand', 9L, 'CXCommentKind')
`CXComment_VerbatimBlockLine` = GenericEnumValue('CXComment_VerbatimBlockLine', 10L, 'CXCommentKind')
`CXComment_VerbatimLine` = GenericEnumValue('CXComment_VerbatimLine', 11L, 'CXCommentKind')
`CXComment_FullComment` = GenericEnumValue('CXComment_FullComment', 12L, 'CXCommentKind')

 setAs("character", "CXCommentKind", function(from) asEnumValue(from, CXCommentKindValues, "CXCommentKind", prefix = NA) )
 setAs("integer", "CXCommentKind", function(from) asEnumValue(from, CXCommentKindValues, "CXCommentKind", prefix = NA) )
 setAs("numeric", "CXCommentKind", function(from) asEnumValue(from, CXCommentKindValues, "CXCommentKind", prefix = NA) )


#####################################
setClass("CXCommentInlineCommandRenderKind", contains = "EnumValue")

CXCommentInlineCommandRenderKind = CXCommentInlineCommandRenderKindValues = structure(c(0L, 1L, 2L, 3L), .Names = c('CXCommentInlineCommandRenderKind_Normal', 'CXCommentInlineCommandRenderKind_Bold', 'CXCommentInlineCommandRenderKind_Monospaced', 'CXCommentInlineCommandRenderKind_Emphasized'))

`CXCommentInlineCommandRenderKind_Normal` = GenericEnumValue('CXCommentInlineCommandRenderKind_Normal', 0L, 'CXCommentInlineCommandRenderKind')
`CXCommentInlineCommandRenderKind_Bold` = GenericEnumValue('CXCommentInlineCommandRenderKind_Bold', 1L, 'CXCommentInlineCommandRenderKind')
`CXCommentInlineCommandRenderKind_Monospaced` = GenericEnumValue('CXCommentInlineCommandRenderKind_Monospaced', 2L, 'CXCommentInlineCommandRenderKind')
`CXCommentInlineCommandRenderKind_Emphasized` = GenericEnumValue('CXCommentInlineCommandRenderKind_Emphasized', 3L, 'CXCommentInlineCommandRenderKind')

 setAs("character", "CXCommentInlineCommandRenderKind", function(from) asEnumValue(from, CXCommentInlineCommandRenderKindValues, "CXCommentInlineCommandRenderKind", prefix = NA) )
 setAs("integer", "CXCommentInlineCommandRenderKind", function(from) asEnumValue(from, CXCommentInlineCommandRenderKindValues, "CXCommentInlineCommandRenderKind", prefix = NA) )
 setAs("numeric", "CXCommentInlineCommandRenderKind", function(from) asEnumValue(from, CXCommentInlineCommandRenderKindValues, "CXCommentInlineCommandRenderKind", prefix = NA) )


#####################################
setClass("CXCommentParamPassDirection", contains = "EnumValue")

CXCommentParamPassDirection = CXCommentParamPassDirectionValues = structure(c(0L, 1L, 2L), .Names = c('CXCommentParamPassDirection_In', 'CXCommentParamPassDirection_Out', 'CXCommentParamPassDirection_InOut'))

`CXCommentParamPassDirection_In` = GenericEnumValue('CXCommentParamPassDirection_In', 0L, 'CXCommentParamPassDirection')
`CXCommentParamPassDirection_Out` = GenericEnumValue('CXCommentParamPassDirection_Out', 1L, 'CXCommentParamPassDirection')
`CXCommentParamPassDirection_InOut` = GenericEnumValue('CXCommentParamPassDirection_InOut', 2L, 'CXCommentParamPassDirection')

 setAs("character", "CXCommentParamPassDirection", function(from) asEnumValue(from, CXCommentParamPassDirectionValues, "CXCommentParamPassDirection", prefix = NA) )
 setAs("integer", "CXCommentParamPassDirection", function(from) asEnumValue(from, CXCommentParamPassDirectionValues, "CXCommentParamPassDirection", prefix = NA) )
 setAs("numeric", "CXCommentParamPassDirection", function(from) asEnumValue(from, CXCommentParamPassDirectionValues, "CXCommentParamPassDirection", prefix = NA) )
