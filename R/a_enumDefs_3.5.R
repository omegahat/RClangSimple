...
CXCommentInlineCommandRenderKindValues = structure(c(0L, 1L, 2L, 3L), .Names = c('CXCommentInlineCommandRenderKind_Normal', 'CXCommentInlineCommandRenderKind_Bold', 'CXCommentInlineCommandRenderKind_Monospaced', 'CXCommentInlineCommandRenderKind_Emphasized'))
...
CXCommentParamPassDirectionValues = structure(c(0L, 1L, 2L), .Names = c('CXCommentParamPassDirection_In', 'CXCommentParamPassDirection_Out', 'CXCommentParamPassDirection_InOut'))
