if(all(clangVersionNum(libclangVersion_Install) == c( 3 ,  9 ))) {
...
`CXCursor_LastExpr` = GenericEnumValue('CXCursor_LastExpr', 148L, 'CXCursorKind')
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 269L, 'CXCursorKind')
...
`CXCursor_LastAttr` = GenericEnumValue('CXCursor_LastAttr', 419L, 'CXCursorKind')
...
`CXCursor_LastExtraDecl` = GenericEnumValue('CXCursor_LastExtraDecl', 602L, 'CXCursorKind')
...
`CXVisibility_Default` = GenericEnumValue('CXVisibility_Default', 3L, 'CXVisibilityKind')
 ...
 setAs("character", "CXVisibilityKind", function(from) asEnumValue(from, CXVisibilityKindValues, "CXVisibilityKind", prefix = NA) )
 setAs("integer", "CXVisibilityKind", function(from) asEnumValue(from, CXVisibilityKindValues, "CXVisibilityKind", prefix = NA) )
 setAs("numeric", "CXVisibilityKind", function(from) asEnumValue(from, CXVisibilityKindValues, "CXVisibilityKind", prefix = NA) )
...
CXCallingConv = CXCallingConvValues = structure(c(0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 100L, 200L), .Names = c('CXCallingConv_Default', 'CXCallingConv_C', 'CXCallingConv_X86StdCall', 'CXCallingConv_X86FastCall', 'CXCallingConv_X86ThisCall', 'CXCallingConv_X86Pascal', 'CXCallingConv_AAPCS', 'CXCallingConv_AAPCS_VFP', 'CXCallingConv_IntelOclBicc', 'CXCallingConv_X86_64Win64', 'CXCallingConv_X86_64SysV', 'CXCallingConv_X86VectorCall', 'CXCallingConv_Swift', 'CXCallingConv_PreserveMost', 'CXCallingConv_PreserveAll', 'CXCallingConv_Invalid', 'CXCallingConv_Unexposed'))
...
`CXEval_UnExposed` = GenericEnumValue('CXEval_UnExposed', 0L, 'CXEvalResultKind')
 ...
 setAs("character", "CXEvalResultKind", function(from) asEnumValue(from, CXEvalResultKindValues, "CXEvalResultKind", prefix = NA) )
 setAs("integer", "CXEvalResultKind", function(from) asEnumValue(from, CXEvalResultKindValues, "CXEvalResultKind", prefix = NA) )
 setAs("numeric", "CXEvalResultKind", function(from) asEnumValue(from, CXEvalResultKindValues, "CXEvalResultKind", prefix = NA) )
