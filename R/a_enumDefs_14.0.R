# Autogenerated 2022-07-25

if(all(clangVersionNum(libclangVersion_Install) == c(14, 0))) {
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 295L, 'CXCursorKind')
