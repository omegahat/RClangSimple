# Autogenerated 2019-07-09

if(all(clangVersionNum(libclangVersion_Install) == c(8, 0))) {
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 279L, 'CXCursorKind')
...
`CXCursor_LastAttr` = GenericEnumValue('CXCursor_LastAttr', 437L, 'CXCursorKind')
