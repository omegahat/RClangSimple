if(all(clangVersionNum(libclangVersion_Install) == c( 3 ,  8 ))) {
...
`CXCursor_LastExpr` = GenericEnumValue('CXCursor_LastExpr', 147L, 'CXCursorKind')
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 260L, 'CXCursorKind')
...
`CXCursor_LastExtraDecl` = GenericEnumValue('CXCursor_LastExtraDecl', 601L, 'CXCursorKind')
