# Autogenerated 2020-12-31

if(all(clangVersionNum(libclangVersion_Install) == c(11, 0))) {
...
`CXCursor_CXXAddrspaceCastExpr` = GenericEnumValue('CXCursor_CXXAddrspaceCastExpr', 129L, 'CXCursorKind')

`CXCursor_CXXTypeidExpr` = GenericEnumValue('CXCursor_CXXTypeidExpr', 130L, 'CXCursorKind')

`CXCursor_CXXBoolLiteralExpr` = GenericEnumValue('CXCursor_CXXBoolLiteralExpr', 131L, 'CXCursorKind')

`CXCursor_CXXNullPtrLiteralExpr` = GenericEnumValue('CXCursor_CXXNullPtrLiteralExpr', 132L, 'CXCursorKind')

`CXCursor_CXXThisExpr` = GenericEnumValue('CXCursor_CXXThisExpr', 133L, 'CXCursorKind')

`CXCursor_CXXThrowExpr` = GenericEnumValue('CXCursor_CXXThrowExpr', 134L, 'CXCursorKind')

`CXCursor_CXXNewExpr` = GenericEnumValue('CXCursor_CXXNewExpr', 135L, 'CXCursorKind')

`CXCursor_CXXDeleteExpr` = GenericEnumValue('CXCursor_CXXDeleteExpr', 136L, 'CXCursorKind')

`CXCursor_UnaryExpr` = GenericEnumValue('CXCursor_UnaryExpr', 137L, 'CXCursorKind')

`CXCursor_ObjCStringLiteral` = GenericEnumValue('CXCursor_ObjCStringLiteral', 138L, 'CXCursorKind')

`CXCursor_ObjCEncodeExpr` = GenericEnumValue('CXCursor_ObjCEncodeExpr', 139L, 'CXCursorKind')

`CXCursor_ObjCSelectorExpr` = GenericEnumValue('CXCursor_ObjCSelectorExpr', 140L, 'CXCursorKind')

`CXCursor_ObjCProtocolExpr` = GenericEnumValue('CXCursor_ObjCProtocolExpr', 141L, 'CXCursorKind')

`CXCursor_ObjCBridgedCastExpr` = GenericEnumValue('CXCursor_ObjCBridgedCastExpr', 142L, 'CXCursorKind')

`CXCursor_PackExpansionExpr` = GenericEnumValue('CXCursor_PackExpansionExpr', 143L, 'CXCursorKind')

`CXCursor_SizeOfPackExpr` = GenericEnumValue('CXCursor_SizeOfPackExpr', 144L, 'CXCursorKind')

`CXCursor_LambdaExpr` = GenericEnumValue('CXCursor_LambdaExpr', 145L, 'CXCursorKind')

`CXCursor_ObjCBoolLiteralExpr` = GenericEnumValue('CXCursor_ObjCBoolLiteralExpr', 146L, 'CXCursorKind')

`CXCursor_ObjCSelfExpr` = GenericEnumValue('CXCursor_ObjCSelfExpr', 147L, 'CXCursorKind')

`CXCursor_OMPArraySectionExpr` = GenericEnumValue('CXCursor_OMPArraySectionExpr', 148L, 'CXCursorKind')

`CXCursor_ObjCAvailabilityCheckExpr` = GenericEnumValue('CXCursor_ObjCAvailabilityCheckExpr', 149L, 'CXCursorKind')

`CXCursor_FixedPointLiteral` = GenericEnumValue('CXCursor_FixedPointLiteral', 150L, 'CXCursorKind')

`CXCursor_OMPArrayShapingExpr` = GenericEnumValue('CXCursor_OMPArrayShapingExpr', 151L, 'CXCursorKind')

`CXCursor_OMPIteratorExpr` = GenericEnumValue('CXCursor_OMPIteratorExpr', 152L, 'CXCursorKind')

`CXCursor_LastExpr` = GenericEnumValue('CXCursor_LastExpr', 152L, 'CXCursorKind')
...
`CXCursor_LastStmt` = GenericEnumValue('CXCursor_LastStmt', 287L, 'CXCursorKind')
...
`CXCursor_LastExtraDecl` = GenericEnumValue('CXCursor_LastExtraDecl', 603L, 'CXCursorKind')
...
`CXType_LastBuiltin` = GenericEnumValue('CXType_LastBuiltin', 39L, 'CXTypeKind')
...
CXTypeNullabilityKind = CXTypeNullabilityKindValues = structure(c(0L, 1L, 2L, 3L), .Names = c('CXTypeNullability_NonNull', 'CXTypeNullability_Nullable', 'CXTypeNullability_Unspecified', 'CXTypeNullability_Invalid'))
