...
\Rpkg{rdyncall} uses GCC-XML to get the information about the routines
and generate the corresponding signatures.  Here we'll show how to do
it with \Rpkg{RCIndex} and directly from the results of
...
\end{CCode}
to its canonical type and the \Rpkg{rdyncall} string \dquote{l}.
